...
| Message actions | 28px | 32px touch targets; the time/stats labels stay visible on touch in a **compact truncated form** (30% width cap + ellipsis, single line); the turn stats line (rounds / times) becomes **wrapped centered capsules** (mainstream community treatment — full information, no collision) |
